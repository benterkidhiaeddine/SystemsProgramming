...
try:
    ...
    print(
        "Usage : ./myif.py cmd1 args ...--then cmd2 args ...[ --else cmd3 args ...] --fi "
    )
    sys.exit(1)
...
try:
    ...
    print("Une erreur est survenue lors du wait")
    sys.exit(1)
...
try:
    ...
    if os.WIFEXITED(status):
        ...
        print(
            f"La commande avec le pid :{pid} a échoué d'étre executé sons statut est {os.WEXITSTATUS(status)}"
        )
